package mobile.fasam.edu.Use_retrofit2.atividade;
...
import mobile.fasam.edu.Use_retrofit2.R;
import mobile.fasam.edu.Use_retrofit2.adapter.CommentsAdapter;
import mobile.fasam.edu.Use_retrofit2.bootstrap.BootstrapApi;
import mobile.fasam.edu.Use_retrofit2.representacao.Comments;
import mobile.fasam.edu.Use_retrofit2.resource.CommentsService;
...
public class CommentsActivity extends AppCompatActivity {
    ...
    public void Adicionar(View view) {
        ...
        txtCommentsId = findViewById(R.id.txtBody);
